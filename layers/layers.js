...
lyr_ElectoralDistricts_3.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', 'ED_2017': 'ED_2017', 'Area_km': 'Area_km', 'Councillor': 'Councillor', });
lyr_Roads_4.set('fieldAliases', {'fid': 'fid', 'name': 'name', });
lyr_ElectoralDistricts_3.set('fieldImages', {'fid': 'TextEdit', 'OBJECTID': 'TextEdit', 'ED_2017': 'TextEdit', 'Area_km': 'TextEdit', 'Councillor': 'TextEdit', });
lyr_Roads_4.set('fieldImages', {'fid': 'TextEdit', 'name': 'TextEdit', });
lyr_ElectoralDistricts_3.set('fieldLabels', {'fid': 'header label', 'OBJECTID': 'header label', 'ED_2017': 'header label', 'Area_km': 'header label', 'Councillor': 'header label', });
